...
void ASokobanCharacter::NotifyControllerChanged()
{
...
void ASokobanCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ASokobanCharacter::Look);
	}
	else
	{
...
void ASokobanCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
